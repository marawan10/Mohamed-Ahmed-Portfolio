    ...
    return (
        <div className="bg-background-secondary border border-border-color rounded-lg p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {metrics.map((metric, index) => (
                    ...
                    >
                        ...
                        <div className="h-2 bg-terminal-bg rounded-full overflow-hidden border border-border-color">
                            <motion.div
                                initial={{ width: 0 }}
            ...
            <div className="mt-8 pt-6 border-t border-border-color grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-terminal-bg p-4 rounded border border-border-color">
