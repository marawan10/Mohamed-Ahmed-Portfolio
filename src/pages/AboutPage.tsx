                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="bg-background-secondary border border-border-color rounded p-6">
                            <div className="dark w-24 h-24 bg-terminal-bg rounded-full mx-auto mb-4 border-2 border-accent-primary flex items-center justify-center">
                    ...
                    <div className="md:col-span-2 space-y-8">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="dark bg-terminal-bg border border-border-color rounded p-4 border-l-4 border-l-yellow-500">
                                ...
                                <div className="dark bg-terminal-bg border border-border-color rounded p-4 border-l-4 border-l-blue-500">
