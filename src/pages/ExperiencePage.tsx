            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-8 relative before:absolute before:left-2 md:before:left-4 before:top-0 before:bottom-0 before:w-px before:bg-border-color">
                    {EXPERIENCES.map((exp, index) => (
                        ...
                        >
                            {/* Timeline Node */}
                            <div className="dark absolute left-0 md:left-2 top-0 w-4 h-4 rounded-full bg-terminal-bg border-2 border-accent-primary transform -translate-x-1.5 md:-translate-x-1.5"></div>
                            ...
                            <div className="bg-background-secondary border border-border-color rounded p-6 hover:border-accent-primary transition-colors group">
                                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-2">
                                    ...
                                    <div className="dark flex items-center gap-2 text-xs font-mono text-text-secondary bg-terminal-bg px-2 py-1 rounded">
                                        <Calendar size={12} />
