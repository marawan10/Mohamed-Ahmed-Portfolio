                        ...
                        <div className="bg-background-secondary border border-border-color rounded p-6">
                            ...
                            <div className="flex gap-6">
                                <a
                                    ...
                                    className="dark p-4 bg-terminal-bg border border-border-color rounded hover:border-accent-primary hover:text-accent-primary transition-all hover:scale-110 group"
                                    aria-label="GitHub"
                                >
                                    <Github size={32} />
                                </a>
                    ...
                    <div className="bg-background-secondary border border-border-color rounded p-8 shadow-lg">
                        ...
                        <form className="space-y-6">
                            <div>
                                ...
                                <input
                                    type="text"
                                    className="dark w-full bg-terminal-bg border border-border-color rounded px-4 py-3 text-text-primary font-mono focus:border-accent-primary focus:outline-none transition-colors"
